...
T = TypeVar("T", bound="PostClientsClientIdDocumentsBody")



@_attrs_define
class PostClientsClientIdDocumentsBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_clients_client_id_documents_body = cls(
            file=file,
            metadata=metadata,
        )


        post_clients_client_id_documents_body.additional_properties = d
        return post_clients_client_id_documents_body
