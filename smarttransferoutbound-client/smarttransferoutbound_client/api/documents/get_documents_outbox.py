...
from ...models.outbox_document_model_i_enumerable_o_data_value import OutboxDocumentModelIEnumerableODataValue
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, OutboxDocumentModelIEnumerableODataValue]]:
    if response.status_code == 200:
        response_200 = OutboxDocumentModelIEnumerableODataValue.from_dict(response.json())
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, OutboxDocumentModelIEnumerableODataValue]]:
    return Response(
...
def sync_detailed(
    *,
...
) -> Response[Union[Any, OutboxDocumentModelIEnumerableODataValue]]:
    r""" Retrieves all outbox documents for the authorized user and its client.
    ...
    result.</td>    <td style=\"padding-left:12px;padding-right:12px;\">/Documents/Outbox$select=id</td>
    ...
    right:12px;\">/Documents/Outbox$filter=id gt 445566</td>    <td style=\"padding-left:12px;padding-
    ...
    style=\"padding-left:12px;padding-right:12px;\">/Documents/Outbox$orderby=id desc</td>    <td
    ...
    right:12px;\">/Documents/Outbox$top=50</td>    <td style=\"padding-left:12px;padding-
    right:12px;\"><a href=\"https://docs.microsoft.com/en-us/odata/client/query-options#top\"
    target=\"_blank\">Documentation🡥</a></td></tr><tr style=\"border: 1px solid rgba(0,0,0,0.08);\">
    ...
    right:12px;\">/Documents/Outbox$skip=25</td>    <td style=\"padding-left:12px;padding-
    ...
    right:12px;\">/Documents/Outbox$count=true</td>    <td style=\"padding-left:12px;padding-
...
def sync(
    *,
...
) -> Optional[Union[Any, OutboxDocumentModelIEnumerableODataValue]]:
    r""" Retrieves all outbox documents for the authorized user and its client.
    ...
    Returns:
        Union[Any, OutboxDocumentModelIEnumerableODataValue]
     """
