...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, SentboxDocumentModelIEnumerableODataValue]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, SentboxDocumentModelIEnumerableODataValue]]:
    return Response(
...
def sync_detailed(
    *,
...
) -> Response[Union[Any, SentboxDocumentModelIEnumerableODataValue]]:
    r""" Retrieves all sent box documents for the authorized user and its client.
    ...
    right:12px;\">/Documents/Sentbox$select=id</td>    <td style=\"padding-left:12px;padding-
    ...
    <td style=\"padding-left:12px;padding-right:12px;\">$filter</td>    <td style=\"padding-
    left:12px;padding-right:12px;\">Restricts the set of items returned.</td>    <td style=\"padding-
    left:12px;padding-right:12px;\">/Documents/Sentbox$filter=id gt 445566</td>    <td style=\"padding-
    left:12px;padding-right:12px;\"><a href=\"https://docs.microsoft.com/en-us/odata/webapi/first-odata-
    api#filter\" target=\"_blank\">Documentation🡥</a></td></tr><tr style=\"border: 1px solid
    rgba(0,0,0,0.08);\">    <td style=\"padding-left:12px;padding-right:12px;\">$orderby</td>    <td
    style=\"padding-left:12px;padding-right:12px;\">Specifies the order in which items are
    returned.</td>    <td style=\"padding-left:12px;padding-right:12px;\">/Documents/Sentbox$orderby=id
    ...
    target=\"_blank\">Documentation🡥</a></td></tr><tr style=\"border: 1px solid rgba(0,0,0,0.08);\">
    <td style=\"padding-left:12px;padding-right:12px;\">$top</td>    <td style=\"padding-
    left:12px;padding-right:12px;\">Limits the number of items returned from a collection.</td>    <td
    style=\"padding-left:12px;padding-right:12px;\">/Documents/Sentbox$top=50</td>    <td
    style=\"padding-left:12px;padding-right:12px;\"><a href=\"https://docs.microsoft.com/en-
    us/odata/client/query-options#top\" target=\"_blank\">Documentation🡥</a></td></tr><tr
    style=\"border: 1px solid rgba(0,0,0,0.08);\">    <td style=\"padding-left:12px;padding-
    right:12px;\">$skip</td>    <td style=\"padding-left:12px;padding-right:12px;\">Excludes the
    specified number of items of the queried collection from the result.</td>    <td style=\"padding-
    left:12px;padding-right:12px;\">/Documents/Sentbox$skip=25</td>    <td style=\"padding-
    left:12px;padding-right:12px;\"><a href=\"https://docs.microsoft.com/en-us/odata/webapi/first-odata-
    api#skip\" target=\"_blank\">Documentation🡥</a></td></tr><tr style=\"border: 1px solid
    rgba(0,0,0,0.08);\">    <td style=\"padding-left:12px;padding-right:12px;\">$count</td>    <td
    style=\"padding-left:12px;padding-right:12px;\">Indicates whether the total count of items within a
    collection are returned in the result.</td>    <td style=\"padding-left:12px;padding-
    right:12px;\">/Documents/Sentbox$count=true</td>    <td style=\"padding-left:12px;padding-
...
def sync(
    *,
...
) -> Optional[Union[Any, SentboxDocumentModelIEnumerableODataValue]]:
    r""" Retrieves all sent box documents for the authorized user and its client.
    ...
    Returns:
        Union[Any, SentboxDocumentModelIEnumerableODataValue]
     """
