...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[ForbiddenProblemDetails, NotFoundProblemDetails, UserModel]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[ForbiddenProblemDetails, NotFoundProblemDetails, UserModel]]:
    return Response(
...
def sync_detailed(
    ...
    *,
...
) -> Response[Union[ForbiddenProblemDetails, NotFoundProblemDetails, UserModel]]:
    r""" Gets a single user by id. Requires admin role.
    ...
    result.</td>    <td style=\"padding-left:12px;padding-right:12px;\">/Users/{id}$select=id</td>
...
def sync(
    ...
    *,
...
) -> Optional[Union[ForbiddenProblemDetails, NotFoundProblemDetails, UserModel]]:
    r""" Gets a single user by id. Requires admin role.
    ...
    Returns:
        Union[ForbiddenProblemDetails, NotFoundProblemDetails, UserModel]
     """
