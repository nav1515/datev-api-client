...
class ErrorMessage:
    """ 
        Attributes:
            error (Union[Unset, str]):  Example: #DCO02301.
            error_description (Union[Unset, str]):  Example: restapi.FormatClientIdFault.
            error_uri (Union[Unset, str]):  Example: https://apps.datev.de/help-center/search?q=DCO02306.
            request_id (Union[Unset, str]):  Example: 0a13eff2-44a9-4de6-90f0-1198241e7c22.
     """
