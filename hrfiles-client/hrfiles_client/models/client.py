...
@_attrs_define
class Client:
    """ Properties of a Client element consisting of client id, consultant number and client number.

        Attributes:
            client_id (Union[Unset, str]): Id with identifies the consultant and client number.
                 Example: 1234567-12345.
            consultant_number (Union[Unset, int]):
            client_number (Union[Unset, int]):
     """
