...
from ...models.user_model_i_enumerable_o_data_value import UserModelIEnumerableODataValue
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[UserModelIEnumerableODataValue]:
    if response.status_code == 200:
        response_200 = UserModelIEnumerableODataValue.from_dict(response.json())
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[UserModelIEnumerableODataValue]:
    return Response(
...
def sync_detailed(
    *,
...
) -> Response[UserModelIEnumerableODataValue]:
    r""" Retrieves users. Requires admin role.
    ...
    result.</td>    <td style=\"padding-left:12px;padding-right:12px;\">/Users$select=id</td>    <td
    ...
    of items returned.</td>    <td style=\"padding-left:12px;padding-right:12px;\">/Users$filter=id gt
    ...
    style=\"padding-left:12px;padding-right:12px;\">/Users$orderby=id desc</td>    <td style=\"padding-
    left:12px;padding-right:12px;\"><a href=\"https://docs.microsoft.com/en-us/odata/webapi/first-odata-
    api#orderby\" target=\"_blank\">Documentation🡥</a></td></tr><tr style=\"border: 1px solid
    rgba(0,0,0,0.08);\">    <td style=\"padding-left:12px;padding-right:12px;\">$top</td>    <td
    style=\"padding-left:12px;padding-right:12px;\">Limits the number of items returned from a
    collection.</td>    <td style=\"padding-left:12px;padding-right:12px;\">/Users$top=50</td>    <td
    style=\"padding-left:12px;padding-right:12px;\"><a href=\"https://docs.microsoft.com/en-
    ...
    left:12px;padding-right:12px;\">/Users$skip=25</td>    <td style=\"padding-left:12px;padding-
    ...
    right:12px;\">/Users$count=true</td>    <td style=\"padding-left:12px;padding-right:12px;\"><a
...
) -> Optional[UserModelIEnumerableODataValue]:
    r""" Retrieves users. Requires admin role.
