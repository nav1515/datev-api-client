...
T = TypeVar("T", bound="PostDocumentsIdPrivateAttachmentBody")



@_attrs_define
class PostDocumentsIdPrivateAttachmentBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_documents_id_private_attachment_body = cls(
            attachment=attachment,
        )


        post_documents_id_private_attachment_body.additional_properties = d
        return post_documents_id_private_attachment_body
