...
T = TypeVar("T", bound="PostDocumentsInboxBody")



@_attrs_define
class PostDocumentsInboxBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_documents_inbox_body = cls(
            files=files,
        )


        post_documents_inbox_body.additional_properties = d
        return post_documents_inbox_body
