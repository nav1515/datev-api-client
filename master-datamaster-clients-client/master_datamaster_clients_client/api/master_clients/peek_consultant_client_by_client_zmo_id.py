...
def sync_detailed(
    ...
    *,
    ...
    """ Retrieve meta data for the consultant client of a specific master client.

     Returns meta data in form of headers for the consultant client of a specific master client which the
    user has access to.
