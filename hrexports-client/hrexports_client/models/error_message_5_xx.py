...
class ErrorMessage5Xx:
    """ 
        Attributes:
            error_description (Union[Unset, str]): Descriptive text of an error behavior Example: Temporary Error while
                processing Request. Please try again!.
            request_id (Union[Unset, str]): UUID identifying the user request Example: 0a13eff2-44a9-4de6-90f0-1198241e7c22.
     """
