...
class Client:
    """ 
        Attributes:
            client_id (Union[Unset, str]): Client Id (Ordnungsbegriff) Example: 1234567-1245.
            consultant_number (Union[Unset, int]): Consultant number (Beraternummer) Example: 1234567.
            client_number (Union[Unset, int]): Client number (Mandantennummer) Example: 12345.
     """
