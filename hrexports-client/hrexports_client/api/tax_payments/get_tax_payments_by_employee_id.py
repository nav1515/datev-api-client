...
from ...models.tax_payments import TaxPayments
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/clients/{client_id}/employees/{employee_id}/taxpayments".format(client_id=client_id,employee_id=employee_id,),
        "params": params,
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[ErrorMessage, ErrorMessage5Xx, TaxPayments]]:
    if response.status_code == 200:
        response_200 = TaxPayments.from_dict(response.json())
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[ErrorMessage, ErrorMessage5Xx, TaxPayments]]:
    return Response(
...
) -> Response[Union[ErrorMessage, ErrorMessage5Xx, TaxPayments]]:
    """ Get the employee's tax payments

     Tax (e.g. church tax or solidarity tax) of an employee can be accessed by its employee-id.
...
def sync(
    ...
    *,
...
) -> Optional[Union[ErrorMessage, ErrorMessage5Xx, TaxPayments]]:
    """ Get the employee's tax payments
    ...
    Returns:
        Union[ErrorMessage, ErrorMessage5Xx, TaxPayments]
     """
