...
from ...models.social_security_payments import SocialSecurityPayments
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/clients/{client_id}/employees/{employee_id}/socialsecuritypayments".format(client_id=client_id,employee_id=employee_id,),
        "params": params,
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[ErrorMessage, ErrorMessage5Xx, SocialSecurityPayments]]:
    if response.status_code == 200:
        response_200 = SocialSecurityPayments.from_dict(response.json())
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[ErrorMessage, ErrorMessage5Xx, SocialSecurityPayments]]:
    return Response(
...
) -> Response[Union[ErrorMessage, ErrorMessage5Xx, SocialSecurityPayments]]:
    """ Get the employee's social security payments

     Social security payments (e. g. current gross social security, allocation1) of a an employee can be
    accessed by its employee-id.
...
def sync(
    ...
    *,
...
) -> Optional[Union[ErrorMessage, ErrorMessage5Xx, SocialSecurityPayments]]:
    """ Get the employee's social security payments
    ...
    Returns:
        Union[ErrorMessage, ErrorMessage5Xx, SocialSecurityPayments]
     """
