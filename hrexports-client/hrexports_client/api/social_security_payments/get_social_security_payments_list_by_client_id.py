...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/clients/{client_id}/employees/socialsecuritypayments".format(client_id=client_id,),
        "params": params,
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[ErrorMessage, ErrorMessage5Xx, list['SocialSecurityPayments']]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in (_response_200):
            response_200_item = SocialSecurityPayments.from_dict(response_200_item_data)
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[ErrorMessage, ErrorMessage5Xx, list['SocialSecurityPayments']]]:
    return Response(
...
) -> Response[Union[ErrorMessage, ErrorMessage5Xx, list['SocialSecurityPayments']]]:
    """ Get the employees' socialsecuritypayments

     Social security payments (e. g. current gross social security, allocation1) of all employees can be
...
def sync(
    ...
    *,
...
) -> Optional[Union[ErrorMessage, ErrorMessage5Xx, list['SocialSecurityPayments']]]:
    """ Get the employees' socialsecuritypayments
    ...
    Returns:
        Union[ErrorMessage, ErrorMessage5Xx, list['SocialSecurityPayments']]
     """
