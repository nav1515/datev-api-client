...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/clients/{client_id}/employees/absences".format(client_id=client_id,),
        "params": params,
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[ErrorMessage, ErrorMessage5Xx, list['Absences']]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in (_response_200):
            response_200_item = Absences.from_dict(response_200_item_data)
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[ErrorMessage, ErrorMessage5Xx, list['Absences']]]:
    return Response(
...
) -> Response[Union[ErrorMessage, ErrorMessage5Xx, list['Absences']]]:
    """ Get the employees' absences

     Absences of all employees of an client can be accessed by the client's client-id.
...
def sync(
    ...
    *,
...
) -> Optional[Union[ErrorMessage, ErrorMessage5Xx, list['Absences']]]:
    """ Get the employees' absences
    ...
    Returns:
        Union[ErrorMessage, ErrorMessage5Xx, list['Absences']]
     """
