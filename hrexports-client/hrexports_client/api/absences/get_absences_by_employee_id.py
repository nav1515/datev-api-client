...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/clients/{client_id}/employees/{employee_id}/absences".format(client_id=client_id,employee_id=employee_id,),
        "params": params,
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Absences, ErrorMessage, ErrorMessage5Xx]]:
    if response.status_code == 200:
        response_200 = Absences.from_dict(response.json())
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Absences, ErrorMessage, ErrorMessage5Xx]]:
    return Response(
...
) -> Response[Union[Absences, ErrorMessage, ErrorMessage5Xx]]:
    """ Get the employee's absences

     Absences of an employee can be accessed by its employee-id.
...
def sync(
    ...
    *,
...
) -> Optional[Union[Absences, ErrorMessage, ErrorMessage5Xx]]:
    """ Get the employee's absences
    ...
    Returns:
        Union[Absences, ErrorMessage, ErrorMessage5Xx]
     """
